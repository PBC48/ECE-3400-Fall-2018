/*
milestone 4 code with FSMs where we integrated line sensor, 
wall sensor, robot movement, microphone, ir, muxes, radio, 
image processing all in one.

Copied from milestone3-4.ino. The difference is the addition 
of image processing file for treasure detection
